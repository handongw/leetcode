...
class Solution:
    def canBeValid(self, s: str, locked: str) -> bool:
        ...
        # "I'm intentionally storing some redundant state in this first version 
        # because it makes debugging and validating the algorithm much easier. 
        # Once I'm confident the logic is correct, I'd compress the state."
        stack = []
        freeCnt = 0
        leftParentheseCnt = 0
