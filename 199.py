...
if __name__ == '__main__':
    ...
    tests = [
        {"n": 1, "vals": [1, 2, 3, None, 5, None, 4], "expected": [1, 3, 4]},
        {"n": 2, "vals": [1, 2, 3, 4, None, None, None, 5], "expected": [1, 3, 4, 5]},
        ...
        {"n": 8, "vals": [1, 2, 3, 4, 5, 6, 7], "expected": [1, 3, 7]},
        {"n": 9, "vals": [1, None, 2, None, 3], "expected": [1, 2, 3]},  # right-skewed
        {"n": 10, "vals": [1, 2, 3, None, None, 4, 5], "expected": [1, 3, 5]},
    ]
